...
void Mac80211p::senseChannelWhileIdle(simtime_t duration) {
...
void Mac80211p::handleUpperMsg(cMessage *msg)
{
    ...
    EV << "Mac80211p::handleUpperMsg " << msg->getName() << "\n";
 ...
 * header fields.
 */
Mac80211Pkt *Mac80211p::encapsMsg(cPacket * netw)
{
...
cMessage *Mac80211p::decapsMsg(Mac80211Pkt *frame) {
 ...
 *  handleLowerMsg()
 */
void Mac80211p::handleMsgNotForMe(cMessage *af, simtime_t duration)
{
 ...
 */
void Mac80211p::handleMsgForMe(Mac80211Pkt *af)
{
 ...
 *  HandleMsgForMe()
 */
void Mac80211p::handleRTSframe(Mac80211Pkt * af)
{
    if(endSifs->isScheduled()) error("Mac80211p::handleRTSframe when SIFS scheduled");
 ...
 *  HandleMsgForMe()
 */
void Mac80211p::handleDATAframe(Mac80211Pkt * af)
{
    NeighborList::iterator it;
    if (rtsCts(af)) cancelEvent(timeout);  // cancel time-out event
    it = findNeighbor(af->getSrcAddr());
    if(it == neighbors.end()) error("Mac80211p::handleDATAframe: neighbor not registered");
    if(af->getRetry() && (it->fsc == af->getSequenceControl())) {
        EV << "Mac80211p::handleDATAframe suppressed duplicate message " << af
           << " fsc: " << it->fsc << "\n";
    }
    else {
    ...
    // wait a short interframe space
    if(endSifs->isScheduled()) error("Mac80211p::handleDATAframe when SIFS scheduled");
    endSifs->setContextPointer(af);
 ...
 */
void Mac80211p::handleACKframe(Mac80211Pkt * af)
{
 ...
 */
void Mac80211p::handleCTSframe(Mac80211Pkt * af)
{
    // cancel time-out event
    cancelEvent(timeout);
    shortRetryCounter = 0;
    // wait a short interframe space
    if(endSifs->isScheduled()) error("Mac80211p::handleCTSframe when SIFS scheduled");
    endSifs->setContextPointer(af);
 ...
 */
void Mac80211p::handleEndContentionTimer()
{
 ...
 */
void Mac80211p::handleTimeoutTimer()
{
    bool rtscts = true;
 ...
 *  frame
 */
void Mac80211p::handleEndSifsTimer()
{
 ...
 *  HandleTimer(cMessage* msg)
 */
void Mac80211p::handleEndTransmission()
{
 ...
 *  handleEndContentionTimer()
 */
void Mac80211p::sendDATAframe(Mac80211Pkt *af)
{
 ...
 */
void Mac80211p::sendACKframe(Mac80211Pkt * af)
{
...
void Mac80211p::sendRTSframe()
{
    ...
    EV << " Mac80211p::sendRTSframe duration: " <<  packetDuration(LENGTH_RTS, br) << " br: " << br << "\n";
 ...
 */
void Mac80211p::sendCTSframe(Mac80211Pkt * af)
{
    ...
    EV << " Mac80211p::sendCTSframe duration: " <<  packetDuration(LENGTH_CTS, br) << " br: " << br << "\n";
    // send CTS frame
    sendDown(frame);
 ...
 */
void Mac80211p::testMaxAttempts()
{
...
Signal* Mac80211p::createSignal(	simtime_t start, simtime_t length,
...
/*
void Mac80211p::receiveBBItem(int category, const BBItem *details, int scopeModuleId)
{
    Enter_Method_Silent();
    ...
    if(category == catRadioState) {
        ...
        case RadioState::SEND:
            ...
            break;
        default:
            error("Mac80211p::receiveBBItem unknown radio state");
            break;
        }
    }
}
 ...
 */
simtime_t Mac80211p::timeOut(Mac80211MessageKinds type, double br)
{
 ...
 */
simtime_t Mac80211p::packetDuration(double bits, double br)
{
    return bits / br + phyHeaderLength / BITRATE_HEADER;
}

const char *Mac80211p::stateName(State state)
{
...
void Mac80211p::setState(State newState)
{
    if (state==newState)
...
void Mac80211p::suspendContention()  {
	assert(!contention->isScheduled());
...
double Mac80211p::retrieveBitrate(int destAddress) {
...
void Mac80211p::addNeighbor(Mac80211Pkt *af) {
